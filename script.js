...
document.getElementById('formularioPesquisa').addEventListener('submit', function(e) {
    ...
    var dadosDoFormulario = {
        ...
        maiorQualidade: document.getElementById('maiorQualidade').value,
        maiorDefeito: document.getElementById('maiorDefeito').value,
    ...
    document.getElementById('maiorQualidade').value = '';
    document.getElementById('maiorDefeito').value = '';
